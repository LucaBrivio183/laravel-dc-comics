...
This is a personal laravel template 

- Removed postCSS and added Sass
...
- Run the `php artisan serve` command in one terminal and `npm run dev` command in a new one.
